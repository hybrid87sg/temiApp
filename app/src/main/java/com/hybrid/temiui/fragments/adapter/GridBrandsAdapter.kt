...
class GridBrandsAdapter(var context: Context, var arrayList: ArrayList<GridItemBrands>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view:View = View.inflate(context, R.layout.brands_grid_item,null)
        val icons:ImageView = view.findViewById(R.id.icons)

        val listItem:GridItemBrands = arrayList[position]
